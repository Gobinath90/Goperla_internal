...
class AuthenticationHelper {
    ...
    async getVerificationCode(outlookPage) {
        Logger.info('Retrieving verification code from Outlook');
    ...
    async completeRegistration(otp: string) {
        Logger.info('Completing registration with OTP');
        ...
        async enterBillingDetails(createBillingAddress) {
            ...
            await test.expect(this.page.getByRole('radiogroup').getByText('Monthly')).toBeVisible();
